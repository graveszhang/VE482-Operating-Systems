...
public:
    ...
    void deleteRow(Object object);

    bool hasCopy(KeyType key);

    bool Duplicate(Iterator &its);

    void Duplicate_helper();
    ...
    /**
     * Get a row of data by its key
     * @tparam ValueTypeContainer
     * @param key
     * @param data
     */
    Iterator getValueByIndex(KeyType key);
